...
EXERCICIO Q (01010001) :
	
	#	Um Posto de combustíveis deseja determinar qual de seus produtos tem 
		a preferência de seus clientes. Escreva um algoritmo para ler 
	...
	#	Caso o usuário informe um código inválido (fora da faixa de 1 a 4) 
		...
		e a quantidade de clientes que abasteceram 
...
public class Main_exercicio_18 {
