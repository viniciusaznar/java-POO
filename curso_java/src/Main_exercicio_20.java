...
EXERCICIO S (01010011) :
	
	#	Leia um valor inteiro N. 
		Este valor será a quantidade de valores inteiros X 
		que serão lidos em seguida. Mostre quantos destes valores X
...
public class Main_exercicio_20 {
